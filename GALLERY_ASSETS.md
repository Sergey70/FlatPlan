# Изображения галереи — PLAN-009

Коллекция содержит 12 PNG: четыре чертежа из предоставленного `.plan` × три палитры редактора (`natural`, `warm`, `contrast`). Это изображения Three.js-сцен FlatPlan, полученные встроенным экспортом PNG. Левый вариант квартиры исключён по уточнению пользователя. Оставлены правый план квартиры (21,43 м² — кухня, 13,55 м² — спальня) и три отдельные схемы санузла.
...
Файлы: `public/gallery/plan-009/images/<план>-<палитра>.png` (1470 × 1205). Соответствующие схемы: `public/gallery/plan-009/plans/<план>.svg` (1000 × 1000).
